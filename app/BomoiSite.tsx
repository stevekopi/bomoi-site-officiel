...
const nav = [
  ["Produit", "/a-propos"], ["Modules", "/modules"], ["Secteurs", "/secteurs"], ["Avantages", "/avantages"], ["Ressources", "/documentation"],
];
...
function Footer() {
  return <footer><div className="footer-grid">
    <div><a className="brand" href="/"><span className="brand-mark">B</span><span>Bomoi</span></a><p>L’ERP moderne qui relie vos équipes, vos sites et vos opérations.</p><span className="placeholder-pill">Coordonnées officielles à compléter</span></div>
